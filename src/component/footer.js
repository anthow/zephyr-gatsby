...
const Footer = () => (
  <StaticQuery
    ...
    render={(data) => (
      <>
        <footer className="flex flex-col mt-20   gap-20 ">
         
          <article className=" bg-slate-400 footer py-2  ">
            <section className="w-10/12 m-auto pt-4 pb-4 flex flex-col md:grid grid-cols-3">
              <div className="col-span-2 items-center md:items-start	 text-center md:text-left flex gap-5 flex-col">
                ...
                <ul className="flex gap-5">
                  ...
                  <a
            href={data.datoCmsLienReseauxSociaux.instagram}
            target="_blank"
            rel="noopener"
          >
            <li className="">
