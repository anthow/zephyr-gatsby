...
const asblPage = ({data}) => {
  ...
  <main className="flex flex-col gap-20 mb-20">
	...
	<article className="m-auto w-10/12 flex flex-col gap-10">
		<h1 className="text-3xl text-bleu-z font-black">{data.datoCmsPageAsbl.titreIntroduction}</h1>
	...
	<article className="flex flex-col gap-10 w-10/12 m-auto">
		<h2 className="text-2xl text-bleu-z text-center font-black">Notre Équipe</h2>
...
<GatsbyImage
              ...
              />
						...
						<div className="flex flex-col gap-2">
							<h3 className="text-lg text-orange-z ">{node.nomEtPrenomDeLaPersonne}</h3>
	...
	<article className="m-auto  w-10/12 flex flex-col md:grid grid-cols-2 gap-10 md:gap-20">
		...
		<section className="flex flex-col gap-5 gap-10">
			<h2 className="text-2xl text-bleu-z font-black ">{data.datoCmsPageAsbl.titreConseil}</h2>
