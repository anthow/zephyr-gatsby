    ...
    <main className="flex flex-col  gap-10  mb-20">
      <article
        ...
        <section className="flex flex-col gap-5 ">
          <h1 className="text-3xl font-black text-bleu-z">{data.datoCmsPageActivite.titrePage}</h1>
          <div
      ...
      <div className="flex flex-col gap-5">
		...
		<h3 className="text-xl font-black text-bleu-z">{node.nomDeLActivit}</h3>
		<p className="italic bg-orange-z w-max text-white font-black px-2"> Le {node.dateEtHeure}</p>
		</div>
